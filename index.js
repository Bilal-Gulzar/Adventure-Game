...
console.log(chalk.bold.green(`${player1.name}`) + " VS " + chalk.bold.red(`${opp.name}`));
while (true) {
    // Player VS Skeleton
    if (playerName.p2 === "Skeleton") {
        ...
        if (ask.in === "Attack") {
            ...
            console.log(chalk.yellow.blue("You Drink Health Portion Your fuel is"), chalk.bold.yellow(`${player1.fuel}.`));
        }
